...
_feresPatrol03 = createGroup [east, true];
_feresPatrol03 setSpeedMode "LIMITED";
_feresPatrol03 enableDynamicSimulation true;
...
_unit01 = _feresPatrol03 createUnit [ "O_G_Soldier_F", _randomSelect , [], 0.5, "FORM"];
_unit01 setUnitLoadout _randomLoadout1;
_unit02 = _feresPatrol03 createUnit [ "O_G_Soldier_F", _randomSelect , [], 0.5, "FORM"];
_unit02 setUnitLoadout _randomLoadout2;

_feresPatrol03 setFormation "LINE";
_feresPatrol03 setBehaviour "SAFE";
...
_feresPatrol03 call addFeresRandomWaypoint;
