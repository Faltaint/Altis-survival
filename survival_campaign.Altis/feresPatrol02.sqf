...
_feresPatrol02 = createGroup [east, true];
_feresPatrol02 setFormation "FILE";
_feresPatrol02 setSpeedMode "LIMITED";
_feresPatrol02 enableDynamicSimulation true;
...
_unit01 = _feresPatrol02 createUnit [ "O_G_Soldier_F", _randomSelect , [], 0.5, "FORM"];
_unit01 setUnitLoadout _randomLoadout1;
_unit02 = _feresPatrol02 createUnit [ "O_G_Soldier_F", _randomSelect , [], 0.5, "FORM"];
_unit02 setUnitLoadout _randomLoadout2;
_unit03 = _feresPatrol02 createUnit [ "O_G_Soldier_F", _randomSelect , [], 0.5, "FORM"];
_unit03 setUnitLoadout _randomLoadout3;
_feresPatrol02 setBehaviour "SAFE";
...
_feresPatrol02 call addFeresRandomWaypoint;
